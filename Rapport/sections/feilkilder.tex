...
Systemet er også sensitivt for sterke harmoniske signaler og raske frekvensendringer (vibrato). I slike tilfeller kan det være utfordrende å spore den korrekte frekvensen, spesielt hvis flere topper i spekteret konkurrerer om å være den dominerende frekvensen. Dette kan føre til at analysen hopper mellom forskjellige frekvenser i stedet for å følge den faktiske tonen.
