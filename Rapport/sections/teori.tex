...
\subsubsection{Ramme lengde ($N$) og Frekvensoppløsning}
...
\parindent \textbf{Tidsoppløsning:} Jo kortere ramme lengde, desto bedre tidsoppløsning, men dette kan føre til redusert frekvensoppløsning.\\[1em]
\parindent \textbf{Frekvensoppløsning:} Jo lengre ramme lengde, desto bedre frekvensoppløsning, men dette kan føre til redusert tidsoppløsning.
\subsubsection{Hop-størrelse og Overlapping}
...
\[
    \Delta t = \frac{H}{f_s} \quad \text{sekunder}
\]
\clearpage
\noindent
