...
\end{figure}
En viktig ting å merke seg er at noen vindusfunksjoner (de fleste) introduserer en faktore som kalles \textit{coherent gain}. Dette refererer til den endringen i amplituden av signalet som skjer når det blir vinduet. For eksempel, Hanning-vinduet reduserer toppamplituden til omtrent 50\% av den opprinnelige verdien, noe som må tas i betraktning ved analyse av signalet. Følgende tabell oppsummerer noen vanlige vindusfunksjoner og deres egenskaper:
\begin{table}[H]
    \centering
...
\begin{figure}[H]
    ...
    \caption{Illustrasjon av parabolsk toppinterpolasjon ved bruk av tre punkter nærmest toppen}
